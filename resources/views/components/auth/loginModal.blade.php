...
<div id="authentication-modal" tabindex="-1" aria-hidden="true"
    class="absolute top-0 backdrop-blur-md w-full h-screen flex justify-center items-center border border-black">
                ...
                <form class="space-y-6" action="#">
                    <div>
                        ...
                        <input type="email" name="email" id="email"
                            class="bg-white border text-sm rounded-lg block w-full p-2.5  dark:placeholder-black-300"
