            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:ml-32 sm:block">
                    <div class="flex space-x-4">
                        <a href="{{route('news')}}"
                            class="hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-base font-medium">News</a>
                        <a href="{{route('about')}}"
                            class="hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-base font-medium">About</a>
                    </div>
                </div>
            </div>
