<x-app-layout>
        <div class="w-full min-h-screen flex items-center flex-col mt-5 px-4">
            <div class="w-full lg:w-4/5 flex flex-col lg:flex-row justify-between items-center gap-5 lg:gap-14">
                <div class="w-full rounded-3xl flex justify-center items-center flex-col gap-5 bg-white bg-opacity-20 py-8 mb-5 lg:mb-0">
                    <div>
            ...
            <div class="w-full lg:w-4/5 px-4 mx-auto">
                ...
                <div class="grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                    @foreach($reports as $report)
                        <a href="">
                            <div class="w-full h-auto bg-white bg-opacity-10 rounded-3xl flex flex-col md:flex-row py-2">
                                <div class="w-full md:w-3/6 h-44">
                                    <img src="{{ asset($report->images->first()->image_path) }}" alt="s" class="w-full h-44 rounded-3xl">
                                </div>
                                <div class="w-full md:w-4/6 h-auto pl-4 overflow-hidden">
                                    <div class="w-full flex flex-col md:flex-row border-b-2 border-white py-1">
                                        <div>
